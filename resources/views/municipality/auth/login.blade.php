...
<body class="text-center">
  <form class="form-signin bg-white rounded" method="POST" action="{{ route('municipality.login') }}" aria-label="{{ __('Municipality Login') }}">
    @csrf
    <a href="/">
    ...
    <h1 class="h3 mb-3 font-weight-normal">Municipality Login</h1>
...
/
    <a class="btn btn-link" href="{{ route('municipality.password.request') }}">
